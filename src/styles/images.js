...
export const getTeamLogo = (logo, inactive = false) => {
	switch (logo) {
		case "america":
			...
			else return require("../assets/teams/america.png");
		case "veracruz":
			if (!inactive) return require("../assets/teams/veracruz.png");
		...
		case "cruzazul":
			if (!inactive) return require("../assets/teams/cruzazul.png");
			else return require("../assets/teams/inactive/cruzazul.png");
		case "guadalajara":
			if (!inactive) return require("../assets/teams/guadalajara.png");
			else return require("../assets/teams/inactive/guadalajara.png");
		case "leon":
			if (!inactive) return require("../assets/teams/leon.png");
			else return require("../assets/teams/inactive/leon.png");
		case "monarcas":
			if (!inactive) return require("../assets/teams/monarcas.png");
			else return require("../assets/teams/inactive/monarcas.png");
		case "monterrey":
			if (!inactive) return require("../assets/teams/monterrey.png");
			else return require("../assets/teams/inactive/monterrey.png");
		case "necaxa":
		...
		case "queretaro":
			if (!inactive) return require("../assets/teams/queretaro.png");
			else return require("../assets/teams/inactive/queretaro.png");
		case "santos":
		...
		case "zacatepec":
			if (!inactive) return require("../assets/teams/zacatepec.png");
			else return require("../assets/teams/inactive/zacatepec.png");
		case "juarez":
